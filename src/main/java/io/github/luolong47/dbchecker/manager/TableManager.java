...
public class TableManager {
    ...
    private void initTableInfoMap() {
                            ...
                            try {
                                ...
                                for (TableCsvResult result : results) {
                                    ...
                                    String[] rowData = new String[] {
                                        ...
                                        result.getSumCols(),
                                        result.getCol(),
                                        result.getSumOraAll() != null ? result.getSumOraAll().toString() : "",
                                        result.getSumOra() != null ? result.getSumOra().toString() : "",
                                        result.getSumRlcmsBase() != null ? result.getSumRlcmsBase().toString() : "",
                                        result.getSumRlcmsPv1() != null ? result.getSumRlcmsPv1().toString() : "",
                                        result.getSumRlcmsPv2() != null ? result.getSumRlcmsPv2().toString() : "",
                                        result.getSumRlcmsPv3() != null ? result.getSumRlcmsPv3().toString() : "",
                                        result.getSumBscopyPv1() != null ? result.getSumBscopyPv1().toString() : "",
                                        result.getSumBscopyPv2() != null ? result.getSumBscopyPv2().toString() : "",
                                        result.getSumBscopyPv3() != null ? result.getSumBscopyPv3().toString() : "",
                                        result.getFormula() != null ? result.getFormula() : "",
                                        result.getFormulaResult() != null ? result.getFormulaResult() : "",
                                        result.getDiff() != null ? result.getDiff().toString() : "",
        ...
        futures.stream()
            ...
            .thenRun(() -> {
                log.info("所有表的列求和计算完成，开始导出CSV文件...");
                // 所有表处理完成后，统一导出一个CSV文件
                exportAllTablesToCsv();
            })
            .exceptionally(e -> {
                log.error("计算列求和时发生错误: {}", e.getMessage(), e);
                return null;
            })
            .join();
    }
    ...
    private void exportAllTablesToCsv() {
        try {
            ...
            synchronized (csvFileLock) {
                if (csvWriter != null) {
                    csvWriter.close();
                    log.info("CSV文件导出完成，文件路径: {}", csvFilePath);
                } else {
                    log.warn("CSV写入器为空，可能初始化失败");
                }
            }
        } catch (Exception e) {
            log.error("关闭CSV写入器时发生错误: {}", e.getMessage(), e);
        }
    }
}
